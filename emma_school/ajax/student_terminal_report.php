...
<button class="btn btn-info btn-sm btn-primary btn-white btn-round" type="button"
        id="print_report" onclick="printContent('printt')">
        ...
        <table id="" class="table table-bordered table-hover" width="100%">
            ...
            <tr style="font-size:x-small;text-transform: uppercase">
                ...
                <td colspan="3"><?php
                    ...
                    $get_dp = $mysqli->query("select * from class where name = '$class'");
...
AND grade >= '$e1' AND id <> '$e1_id'");
                        ...
                        $get_e2_id = $mysqli->query("select id from student_assessment where grade = '$e2' and
 academic_year = '$academic_year' and term = '$term' and type = 'Elective' and student_id = '$student_id'");
...
FROM student_assessment
WHERE academic_year = '$academic_year' AND term = '$term' AND type = 'Elective' AND student_id = '$student_id'
AND grade >= '$e2' AND id <> '$e2_id' AND id <> '$e1_id'");
...
AND grade >= '$elective_grade_1' AND id <> '$id'");
            ...
            <tr style="font-size:x-small;text-transform: uppercase">
                ...
                <td colspan="3"><?php $get_pos = $mysqli->query("SELECT
                        ...
                        class = '$class' AND term = '$term') AS RNK,
                        raw_score
                        FROM student_assessment b WHERE academic_year = '$academic_year' AND
                        class = '$class' AND term = '$term' AND student_id='$student_id'");
...
s.`grade`,s.`grade_display`
                ...
                while ($row = $que->fetch_assoc()) {
                    ...
                    <tr style="font-size:x-small;text-transform: uppercase">
                        ...
                        course = '$course' AND class = '$class' AND term = '$term') AS RNK,
                        total
                        FROM student_assessment b WHERE academic_year = '$academic_year' AND
                        course = '$course' AND class = '$class' AND term = '$term' AND student_id='$student_id'");

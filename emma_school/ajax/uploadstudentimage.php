...
$res=$mysqli->query("select * from student where `student_id` = '$randno'");
$rowcount = mysqli_num_rows($res);


if ($rowcount == "0"){

    $insertfile  = $mysqli->query("INSERT INTO  student (picture, student_id)
    ...
    $insertfile  = $mysqli->query("UPDATE `student`
SET `picture` = '$newfile'

WHERE `student_id` = '$randno'") or die (mysql_error());

    ...
    <div class="widget-body">
        ...
        <div class="widget-main">
                    ...
                    <div class="step-pane active" data-step="1">
                        ...
                        <form class="form-horizontal" id="validation-form"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    <div class="clearfix">
                                        <input type="file" id="edit_student_image"
                                               name="image"
                                               class="col-xs-12 col-sm-12"/>
                                    </div>
                                </div>
                                        ...
                                        <div class="clearfix">
                                            <select
                                                ...
                                                while ($row = $cl_name->fetch_assoc()) {
                                                    ...
                                                    <option <?php if (@$row['course'] == "<?php echo $course?>") echo "Selected" ?>><?php echo $course ?></option>
            ...
            <div class="wizard-actions">
                ...
                <button class="btn btn-success btn-next" data-last="Update">
                    Continue
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $('#edit_student_image').uploadifive({
            'auto': false,
            'method': 'post',
            ...
            'dnd': false,
            'uploadScript': 'ajax/edituploadstudentimage.php',
        ...
        $('#fuelux-wizard-container')
            ...
            .on('finished.fu.wizard', function (e) {
                ...
                if (error2 == "") {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "ajax/savestudentdetails_edit.php",
                        data: {
                        ...
                        success: function (text) {
                            ...
                            swal("Submitted!", "Student Info Updated", "success");
                    ...
                    $('#edit_student_image').uploadifive('upload');

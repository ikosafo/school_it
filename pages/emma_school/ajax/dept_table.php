...
$qudep=$mysqli->query("select * from department  ORDER BY id");
...
<table id="" class="table table-striped table-bordered table-hover dynamic-table">
    ...
    <?php
    while($fet_dep=$qudep->fetch_assoc())
    {
        ...
        <tr>
            ...
            <td><?php echo $fet_dep['name'];?></td>

            <td>
                <a href="#" data-toggle="modal" data-target="#edit-dept-form"
                   class="getfulldetails" i_index="<?php echo $fet_dep['id'];?>">Edit</a></td>
            <td>
                <a href="#" class="delete_dept" i_index="<?php echo $fet_dep['id'];?>">
                    Delete</a></td>
...
<script>
    ...
    $('#save_dept_btn').click(function () {
        ...
        var dept_branch = $('#dept_branch').val();
    ...
    $('#edit_dept_btn').click(function () {
        ...
        var dept_name = $('#dept_name_ed').val();
        ...
        if (dept_name == "") {
            error += 'Please enter department \n';
            document.dept_form_ed.dept_name.focus();
        }
